    ...
    <div className={` ${variant === "recommendation" ? "flex flex-col shadow-[0_0_26.37px_rgba(111,111,111,0.25)]" : "flex shadow-lg"} p-4 rounded-3xl gap-4`}>
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        {variant === "recommendation" ? 
          <p className="text-[18px] text-[#9CA3AF] flex items-center gap-1">
            <span className="text-[25px] text-[#1C64F2]"><IoLocationOutline /></span> {location}
          </p> : 
          <h6 className="text-[#111928] text-[25px] font-medium">{location}</h6>
        }
        {variant === "tour" && (
